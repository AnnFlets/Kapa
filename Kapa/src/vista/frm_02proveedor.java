 ...
 */
public class frm_02proveedor extends javax.swing.JFrame {

    /**
     * Creates new form frm_01producto
     */
    public frm_02proveedor() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel12.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/fondo_general.jpeg"))); // NOI18N
        getContentPane().add(jLabel12, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 0, 700, 160));

        jLabel13.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/fondo_general.jpeg"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frm_02proveedor.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frm_02proveedor().setVisible(true);
            }
        });
    }
